...
$EmailFrom = "";
$EmailTo = "gevann@designguru.co.za";
...
// if(isset($_POST['user_subscribe_mobile'])){ $MobileSubscribe = "Yes"; }else{ $MobileSubscribe = "No"; }
...
// $Body .= $EmailSubscribe;
// $Body .= "\n";
// $Body .= "Recieve Updates Via Mobile: ";
// $Body .= $MobileSubscribe;
// $Body .= "\n";
// // send email 
// $Body .= "Date Of Birth: ";
// $Body .= $Birthday;
