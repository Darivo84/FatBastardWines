  ...
  <?php include '../includes/header_nav.php'; ?>
    <div class="main-content contact-copy competition-copy">
      <div>
        ...
        <p class="small">We’re giving you the chance to win an all expenses paid weekend away for two at <i><b><a target="_blank" href="http://www.hippohollow.co.za">Hippo Hollow Country Estate</a></b></i> in Mpumalanga.<i> Enter before 30 September 2015. </i></p>
				<br>
				<p>
					Cheers!
				</p>
