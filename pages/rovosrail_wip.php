  ...
  ?>
    <div class="main-content contact-copy competition-copy rovos_main_banner">
        ...
        THE ROVOS RAIL
				...
				<br>
        <p class="small">You could win an extravagant trip for two aboard Rovos Rail.</p>
        <p class="small"><span class="highlight">HOW TO ENTER:</span></p>
        <p class="small">Buy any FAT bastard wine and SMS the last 4 digits of the bottle barcode, your name and the rst six digits
of your South African ID number to 34705</p>
        <p class="small">Or, simply complete your details below. Online entries stand a chance of winning a case of FAT bastard
wine weekly.</p>
    ...
    <div class="contact-form competition-form">
      <div>
      <span class="highlight">FILL IN YOUR DETAILS AND STAND A CHANCE TO WIN!</span>
        <form id="competition_form" method="post" action="/pages/rovosrail_thankyou.php">
            <input type="text" name="first_name" placeholder="NAME"></input>
            <input type="text" name="last_name" placeholder="SURNAME"></input>
            <input type="email" name="email" placeholder="EMAIL"></input>
            <input type="text" name="mobile" placeholder="MOBILE NO."></input>
            <div>
            <label>GENDER:</label>
              <input id="radio-1" class="radio-custom" name="gender" value="male" type="radio">
              <label for="radio-1" class="radio-custom-label">Male</label>
                <input id="radio-2" class="radio-custom" name="gender" value="female" type="radio">
                <label for="radio-2" class="radio-custom-label">Female</label>
            </div>
            <p>BIRTHDAY: <input type="text" id="datepicker" name='dob' placeholder="YYYY-MM-DD"></p>

            <br>
                    <div id="countries" class="row">
            <div class="th">Country</div>
            <select id="country_select" name="country"><option value="empty">Please Select</option>
        ...
        <div id="suburb" class="row" style='display:none;'>
            ...
            <span class="highlight">WHICH FAT BASTARD WINE IS YOUR FAVOURITE?</span>
            ...
            <span class="highlight">WHICH SOCIAL MEDIA CHANNELS DO YOU USE ON A REGULAR BASIS?</span>
            ...
            <span class="highlight">YES, I WOULD LIKE TO RECEIVE FAT BASTARD WINERY UPDATES VIA:</span>
            ...
            <div>
              <div class="div_subscriptions">
                  <input id="opt_in_email" class="checkbox-custom" name="opt_in_email" type="checkbox" value="1">
                  <label for="opt_in_email" class="checkbox-custom-label">EMAIL</label>
              </div>
              <div class="div_subscriptions">
                  <input id="opt_in_sms" class="checkbox-custom" name="opt_in_sms" type="checkbox" value="yes">
                  <label for="opt_in_sms" class="checkbox-custom-label">SMS</label>
              </div>
            </div>

            <div class="div_over_18">
                <input id="accept_terms" class="checkbox-custom" name="accept_terms" type="checkbox" value="1">
                <label for="accept_terms" class="checkbox-custom-label">I AM OVER 18 AND HAVE READ AND ACCEPT THE <a href="/tandc.html" class="highlight">TERMS & CONDITIONS</a>.</label>
            </div>
            <input type="image" src="/pages/rovosrail/images/submit.png" border="0" alt="Submit" style="height:40px; width:140px; padding:0px; margin:0px;"/>  
      </form>
    </div>
    </div>
