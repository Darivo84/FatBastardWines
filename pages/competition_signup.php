  ...
  <?php include '../includes/header_nav.php'; ?>
    <div class="main-content contact-copy competition-copy">
      <div class="fat-chance">
        ...
        We’re all about <span class="highlight" style="font-variant:small-caps; font-size:140%;">living large</span>,</p>

				<p class="small">
					and what better way to live large than to kick back in the sun,  <i>a glass of wine in hand</i>, a loved one beside you, and a big blue ocean view beckoning you ever closer.
				</p>
				<br>
        <p class="small"> Enter our competition and stand to win a luxurious weekend getaway in <i><b>Clifton</b></i> worth R50 000. <br> <br>


<i class="highlight">Enter before 31 December 2015.</i>
<!-- <br>
...
<!-- <script language='JavaScript1.1' src='//pixel.mathtag.com/event/js?mt_id=867222&mt_adid=116130&v1=&v2=&v3=&s1=&s2=&s3='></script> -->
<script language='JavaScript1.1' src='//pixel.mathtag.com/event/js?mt_id=867223&mt_adid=116130&v1=&v2=&v3=&s1=&s2=&s3='></script>
...
//                 $.getScript('//pixel.mathtag.com/event/js?mt_id=867223&mt_adid=116130&v1=&v2=&v3=&s1=&s2=&s3=');


                $('#success').text('Thanks. We’re thrilled to welcome you to our pod of FAT bastards and will announce the winner on 11 January 2015.');
                setTimeout(function() {
                  $('#success').text('');
                }, 8000);
                setTimeout(function() {
