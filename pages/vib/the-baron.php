...
<div class="wine-lightbox vib vib" style="" id="merlot">
	<div class="left">

			<div class="bottle-container">
				<img width="267" height="183" class="large-img" src="../../pieces/vib/the-baron/1.jpg" alt="">
				<ul class="social-icons thumbs">
					<li><img width="97" height="97" src="../../pieces/vib/the-baron/1-thumb.jpg" alt="" /></li>
					<li><img width="97" height="97" src="../../pieces/vib/the-baron/2-thumb.jpg" alt="" /></li>
					<li><img width="97" height="97" src="../../pieces/vib/the-baron/3-thumb.jpg" alt="" /></li>
				</ul>
			</div>
	...
	<div class="right">
		...
		<div class="middle">
			<p>The relaxed mood invites you in and embraces you as you walk through the door.The menu, being so large offers a fairly diverse selection of dishes. A favourite are the good, hearty, traditional fare (Home-made Pie and the old favourite Fish and Chips) that reminds you of Mum's home cooking.</p>
		<h5 class="no-margin">BRYANSTON</h5>
			<p><b>Address</b><br>No 1, The Wedge, Main Rd & Posthouse Road Bryanston, Johannesburg, 2191.<br>
			<b>Phone</b><br>+27 (0)11 706 0632/6373</p>
			<h5 class="no-margin">SANDOWN</h5>
			<p><b>Address</b><br>Shop 11, 24 Central, 6 Gwen Lane, Sandton, 2196.<br>
			<b>Phone</b><br> +27 (0)11 883 8435/6</p>
			<h5 class="no-margin">FOURWAYS</h5>
			<p><b>Address</b><br>No 3 Selbourne Rd, Hammets Crossing Office Park, JHB North.<br>
			<b>Phone</b><br> +27 (0)11 704 7851/7859</p>
		</div>
		<div class="bottom">
			<a href="#"></a> <br>
			<a class="highlight" href="http://www.thebaron.co.za" target="_blank">www.thebaron.co.za</a>
