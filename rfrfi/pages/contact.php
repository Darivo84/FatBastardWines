...
<!-- 		<input class="date-select day" name="day" id="day" value="Day"/>
<input class="date-select month" name="month" id="month" value="Month" />
<input class="date-select year" name="year" id="year" value="Year" />
 -->
